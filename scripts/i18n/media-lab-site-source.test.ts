...
describe("media-lab-site i18n source collection", () => {
  ...
  it("keeps the story reader route vocabulary in its own namespace", async () => {
    ...
    expect(source).toMatchObject({
      ...
      "storyReader.modeDialog.title": expect.any(String),
      ...
      "storyReader.player.hint.rotateToPlay": expect.any(String),
      "storyReader.player.hint.tapToLoad": expect.any(String),
      "storyReader.player.hint.tapToPlay": expect.any(String),
      ...
      "storyReader.state.scenarioError": expect.any(String),
