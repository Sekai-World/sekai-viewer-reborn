...
const SEEDS = [
  ...
  },
  {
    ...
    strategy:
      "Pure white bg lets a saturated rose-red primary do all the brand work, paired with a deeper crimson accent for hierarchy — the Stripe/Glossier move where the color carries the mood."
  },
  {
    id: "seed-013",
    oklch: [0.4, 0.13, 20.0],
  ...
  },
  {
    ...
    strategy:
      "Hold the seed's muted teal as primary, pair with a sharper cyan-leaning accent for interactive lift, and let a pure white surface do the disappearing act so the brand reads as a tool, not an atmosphere."
  },
  {
    id: "seed-162",
  ...
  },
  {
    ...
    strategy:
      "Pure white surface lets the considered indigo-blue primary carry the entire brand; a deeper navy accent provides hierarchy without warmth, keeping the palette in a single cool family for that focused-software feel"
  },
  {
    id: "seed-166",
  ...
  },
  {
    ...
    strategy:
      "Pure black bg lets the indigo primary carry all the cognitive-focus weight, with a slightly brighter periwinkle accent for interactive lift — the surface disappears so the tool feels weightless."
  },
  {
    id: "seed-189",
  ...
  },
  {
    ...
    strategy:
      "Hold the seed as a deep indigo primary against pure white, then pair with a slightly warmer, lighter periwinkle accent to create gentle hue separation without breaking the disciplined tool-brand register."
  },
  {
    id: "seed-129",
  ...
  },
  {
    ...
    strategy:
      "Pure black canvas lets a saturated indigo primary do all the brand work, with a cooler cyan-violet accent providing UI signal without competing."
  },
  {
    id: "seed-131",
  ...
  },
  {
    ...
    strategy:
      "Pure white bg lets the indigo seed do all the brand work as primary, with a slightly darker, more saturated violet-shifted accent for hierarchy and interactive states — the surface disappears so the brand color reads as the entire identity."
  },
  {
    id: "seed-132",
    ...
    strategy:
      "Pure white surface lets a muted indigo-violet primary and a slightly cooler accent do all the brand work, keeping the register calm and software-like rather than theatrical."
  },
  {
    id: "seed-090",
    ...
    strategy:
      "Anchor the seed as a confident product primary on pure white, with a cooler indigo-shift accent that reads as a sibling tool color, so the brand violet does all the emotional work."
  },
  {
    id: "seed-133",
  ...
  {
    id: "seed-094",
    oklch: [0.533, 0.125, 294.3],
    mood: "Linear-style considered tool indigo — the violet of a focused product surface, calm authority for a creative workspace",
    strategy:
      "Pure white canvas lets the indigo-violet primary carry the entire brand voice; accent shifts hue slightly toward blue for a cool, tool-like duotone rather than warm decorative pairing."
  },
  {
    id: "seed-137",
    ...
    strategy:
      "Pure black surface lets a single restrained indigo-violet carry the brand, with a cooler periwinkle accent providing UI hierarchy without competing — Vercel/Linear dark-mode discipline."
  },
  {
    id: "seed-100",
  ...
  },
  {
    ...
    strategy:
      "Held the seed as a deep plum primary against pure white so the brand color does the emotional work; paired with a muted rose accent for warmth without breaking the productivity-tool restraint."
  },
  {
    id: "seed-107",
    oklch: [0.5, 0.2, 340.0],
  ...
  },
  {
    ...
    strategy:
      "pure white surface lets a single deep berry-rose primary do all the brand work, paired with a cooler indigo accent for the contrast move you see in modern product marketing"
  },
  {
    id: "seed-113",
  ...
  },
  {
    ...
    strategy:
      "Pure white surface lets a saturated rose primary do the brand work, paired with a deep plum accent for hierarchy — the Stripe move applied to a pink hue."
  },
  {
    id: "seed-115",
  ...
  },
  {
    ...
    strategy:
      "Pure white bg lets a saturated rose-magenta primary carry all the brand energy, paired with a cooler indigo accent for trustworthy contrast — the Stripe move applied to a pink hue."
  },
  {
    id: "seed-231",
    ...
    strategy:
      "Default A pure white bg lets the saturated pink-magenta primary do all the brand work, with a near-complementary cool teal accent for tool-like clarity and a neutral ink for editorial calm"
  },
  {
    id: "seed-116",
