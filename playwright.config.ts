...
export default defineConfig({
  ...
  webServer: {
    command:
      "pnpm --filter @apps/account-site --filter @apps/content-site --filter @apps/media-lab-site --filter @apps/tools-site exec svelte-kit sync && pnpm --dir apps/content-site exec vite dev --configLoader native --port 4105",
