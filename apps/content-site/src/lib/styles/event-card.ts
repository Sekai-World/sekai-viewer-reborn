...
export const EVENT_LIST_CARD_IMAGE_CLASS = `h-full w-full object-contain drop-shadow-[0_10px_18px_rgba(0,0,0,0.08)] transition-[filter] ${EVENT_CARD_HOVER_TIMING_CLASS} group-hover:brightness-[1.02]`;
