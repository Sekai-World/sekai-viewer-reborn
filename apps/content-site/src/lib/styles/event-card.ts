const EVENT_CARD_BASE_SHADOW_CLASS = "shadow-sm";
...
export const EVENT_CARD_BANNER_BODY_CLASS = `${EVENT_CARD_BODY_CLASS} archive-event-banner-body`;

export const EVENT_CARD_EMPTY_BODY_CLASS = `${EVENT_CARD_BODY_CLASS} archive-event-banner-empty-body`;
...
export const EVENT_CARD_IMAGE_CLASS = `mx-auto h-full max-h-full w-full max-w-full object-contain drop-shadow-md md:w-3/4 md:min-w-[min(200px,100%)]`;
