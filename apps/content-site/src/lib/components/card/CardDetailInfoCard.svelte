  ...
  {#if value}
    ...
    <svelte:element
      ...
      class={`content-card-inset flex items-center gap-3 rounded-xl p-3 sm:px-4 outline-none transition-[background-color,border-color,transform] duration-180 ease-out ${
        unitHref
          ? "group/card-unit-row hover-lift hover:border-primary/35 hover:bg-primary/5 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          : ""
      }`}
...
{#snippet characterRow(character: CardDetailCharacter)}
  ...
  <svelte:element
    ...
    class={`content-card-inset flex items-center justify-between gap-4 rounded-xl p-3 sm:px-4 ${
      characterHref
        ? "group/card-character-row outline-none transition-[border-color,background-color,transform] duration-180 ease-out hover-lift hover:border-primary/35 hover:bg-primary/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        : ""
    }`}
