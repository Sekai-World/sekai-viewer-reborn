...
export const parseCharacter = (
  ...
  return {
    ...
    firstName,
    givenName,
    firstNameRuby: getString(node.firstNameRuby),
    givenNameRuby: getString(node.givenNameRuby),
    firstNameEnglish: getString(node.firstNameEnglish),
    givenNameEnglish: getString(node.givenNameEnglish),
    gender: getString(node.gender),
    supportUnitType: getString(node.supportUnitType),
