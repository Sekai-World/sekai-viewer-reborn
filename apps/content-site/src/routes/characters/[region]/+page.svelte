    ...
    <div class="flex flex-col items-center gap-4 sm:gap-5" aria-busy="true">
      {#each Array(6) as _, groupIndex (groupIndex)}
        ...
        >
          ...
          <div class="flex max-w-full flex-nowrap items-center justify-center gap-2 overflow-x-hidden px-2 py-2 sm:gap-6 sm:px-3 lg:gap-10">
    ...
    <div class="flex flex-col gap-4 sm:gap-5">
      {#each groups as [group, characters] (group)}
        ...
        >
          ...
          {/if}
          <div
            class="flex max-w-full flex-nowrap items-center justify-center gap-2 overflow-x-auto px-2 py-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:gap-6 sm:px-3 lg:gap-10"
          >
