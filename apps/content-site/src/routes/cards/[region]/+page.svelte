<script lang="ts">
  ...
  let cardListFilterAttrLabel = $state(getInitialI18nText("attributeLabel"));
  let cardListFilterCharacterLabel = $state(getInitialI18nText("characterLabel"));
  let cardListFilter3dmvCutInLabel = $state(getInitialI18nText("cardListFilter3dmvCutInLabel"));
  let cardListFilterRarityLabel = $state(getInitialI18nText("rarityLabel"));
  ...
  let cardListFilterTypeLabel = $state(getInitialI18nText("typeLabel"));
  ...
  const applyTranslations = (translate: (key: string) => string): void => {
    ...
    cardListFilterAttrLabel = translate("attributeLabel");
    cardListFilterCharacterLabel = translate("characterLabel");
    cardListFilter3dmvCutInLabel = translate("cardListFilter3dmvCutInLabel");
    cardListFilterRarityLabel = translate("rarityLabel");
    ...
    cardListFilterTypeLabel = translate("typeLabel");
