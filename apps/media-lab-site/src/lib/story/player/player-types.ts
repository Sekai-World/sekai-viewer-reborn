...
import type { IScenarioData, ILive2DModelData } from "../scenario-types";
import type BaseAnimation from "./animation/BaseAnimation";
...
export interface ILive2DTextResolver {
  resolve(
    key: string,
    originalText: string
  ): { displayText: string; translatedText: string | null };
}
